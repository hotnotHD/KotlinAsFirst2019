...
class Tests {
    ...
    fun dateStrToDigit() {
        ...
        assertEquals("", dateStrToDigit("aaaaaaa aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa aaaaaaaaaaa"))
    }
    ...
    @Tag("Hard")
    fun bestHighJump() {
        assertEquals(230, bestHighJump("220 + 224 %+ 228 %- 230 + 223 %%- 234 %"))
    ...
    fun computeDeviceCells() {
        assertEquals(listOf(376), computeDeviceCells(1, "[]++++[+++]", 501))
